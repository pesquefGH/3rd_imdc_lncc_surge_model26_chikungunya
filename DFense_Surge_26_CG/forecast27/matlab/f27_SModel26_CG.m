% LNCC SURGE Model 26 CG Chikungunya- Forecast 2027
...
% 6) Provide a forecast for years 2026-2027 
...
ind_EW25_2026=441+52+52+52+52; % time index of EW 25 of 2026 

dcases=M{:,3};   % time-series of the surges (incidence curves) across the EWs 

dcases_orig=dcases;  % stores the original time-series up to EW 25 of 2026

dcases=dcases(1:ind_EW25_2026);  % crops time-series at EW 25 of 2026 (including)
...
dcasesfs=dcasesf(41:ind_EW25_2026);  % selects filtered data from 
% EW 41/2014 to EW 25/2026

% From the time-series 'dcasesfs' of the Chikungunya surges, we obtain 
% an average surge curve.
...
% A simple predictor to forecast the cases in the forecast 2027 task is to generate
...
mg=param(1);  % mean of value of g (from 2014 to 2026)
sigma=param(2); % standard deviation of value of g (from 2014 to 2026)

MC=10000;  % number of montecarlo runs for forecast surges in 2027
...
% from EW 41 of 2026 to EW 40 of 2027
...
writetable(T,['..\spreadsheets\f27_SModel26_CG_',...
...
print(['..\plots\f27_SModel26_CG_',UF],'-dpdf')
